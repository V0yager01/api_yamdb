    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(validators=[reviews.validators.validate_date], verbose_name='Год выпуска')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(error_messages={'validators': 'Оценка должна быть в диапазоне 1-10'}, validators=[reviews.validators.validate_score], verbose_name='Оценка')),
